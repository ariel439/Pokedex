    ...
    return(
        <View style={styles.container}>
            <View style={styles.top}>
                <Icon name="arrow-back-outline" size={35} onPress={() => router.push("gen3")}></Icon>
                <Text style={styles.title}>Generation 4</Text>
                <Icon name="arrow-forward-outline" size={35} onPress={() => router.push("gen5")}></Icon>
            </View>
            <FlatList
                data={pokemons} 
