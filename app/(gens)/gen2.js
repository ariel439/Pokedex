    ...
    return(
        <View style={styles.container}>
            <View style={styles.top}>
                <Icon name="arrow-back-outline" size={35} onPress={() => router.push("home")}></Icon>
                <Text style={styles.title}>Generation 2</Text>
                <Icon name="arrow-forward-outline" size={35} onPress={() => router.push("gen3")}></Icon>
            </View>
            <FlatList
                data={pokemons} 
