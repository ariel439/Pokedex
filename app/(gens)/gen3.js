    ...
    return(
        <View style={styles.container}>
            <View style={styles.top}>
                <Icon name="arrow-back-outline" size={35} onPress={() => router.push("gen2")}></Icon>
                <Text style={styles.title}>Generation 3</Text>
                <Icon name="arrow-forward-outline" size={35} onPress={() => router.push("gen4")}></Icon>
            </View>
            <FlatList
                data={pokemons} 
