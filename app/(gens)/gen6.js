    ...
    return(
        <View style={styles.container}>
            <View style={styles.top}>
                <Icon name="arrow-back-outline" size={35} onPress={() => router.push("gen5")}></Icon>
                <Text style={styles.title}>Generation 6</Text>
                <Icon name="arrow-forward-outline" size={35} onPress={() => router.push("gen7")}></Icon>
            </View>
            <FlatList
                data={pokemons} 
